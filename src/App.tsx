  ...
  return (
    <div>
      <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/80 backdrop-blur">
        <div className="mx-auto flex px-4 md:px-28 flex-col gap-2 md:gap-4 py-2 md:py-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <nav className="flex gap-1 md:gap-3 text-xs md:text-sm font-medium overflow-x-auto">
            <NavLink
              to="/"
              className={({ isActive }) =>
                `rounded-lg px-2 md:px-4 py-1.5 md:py-2 whitespace-nowrap ${
                  isActive
